...
合计: **297,850** 行代码（覆盖前 5 种语言、共 **1503** 个文件）。
...
- **Star**: 104,227 · **Fork**: 13,059 · **开放 issue**: 6,030 · **贡献者**: 290

## 累计统计

- **发布数**: 259 · **已合并 PR**: 977 · **开放 PR**: 65 · **已关闭 issue**: 5888 · **开放 issue**: 142 · **提交数**: 6352
...
在 [repology.org](https://repology.org/project/pi) 上共有 **8** 个发行版报告此项目。**6** 个 ✅ 已是最新上游版本，**2** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260912.yml` · 2026-09-12T06:11:37Z._
