...
[![x-cmd/install — pi Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/pi.svg?lang=zh)](https://x-cmd.com/install/pi)
...
合计: **352,239** 行代码（覆盖前 5 种语言、共 **1699** 个文件）。
...
- **最新版本**: `v0.87.1` (2026-09-22)
- **最近提交**: 2026-09-25
- **Release 含资产**: 10 个

## 流行度

- **Star**: 109,410 · **Fork**: 13,903 · **开放 issue**: 6,431 · **贡献者**: 293

## 累计统计

- **发布数**: 263 · **已合并 PR**: 1008 · **开放 PR**: 66 · **已关闭 issue**: 6271 · **开放 issue**: 160 · **提交数**: 6546
...
_数据快照: `data/card/260926.yml` · 2026-09-26T06:09:47Z._
